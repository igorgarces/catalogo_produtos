...
void main() async {
  ...
  runApp(MyApp(productsRepo: productsRepo, favRepo: favRepo, ordersRepo: ordersRepo));
}
...
class MyApp extends StatefulWidget {
  ...
  const MyApp({super.key, required this.productsRepo, required this.favRepo, required this.ordersRepo});
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => CartNotifier(ordersRepo: widget.ordersRepo)),
        ChangeNotifierProvider(create: (_) => widget.favRepo),
        ChangeNotifierProvider(create: (_) => ProductsNotifier(repo: widget.productsRepo, favRepo: widget.favRepo)),
      ],
      child: MaterialApp(
